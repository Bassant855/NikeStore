...
import { selectCartItems, selectCartState, selectTotalAmount, selectTotalQTY, setCleareCartItems, setGetTotals, setOpenCart } from './rtk/CartSlice'
const Cart = () => {
    ...
    const onClrearCartItems = () => {
      dispatch(setCleareCartItems())
    }
    useEffect(() => {
  ...
  return (
    <>
        ...
        >
          <CartCount  onCartToggle={onCartToggle} onClrearCartItems={onClrearCartItems} totalQTY={totalQTY} />
