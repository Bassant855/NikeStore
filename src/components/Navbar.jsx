...
import { setOpenCart,selectTotalQTY } from './rtk/CartSlice';
  ...
  return (
    <>
      <header className={
        ...
        'fixed top-0 left-0 right-0 flex items-center justify-items-center opacity-100 z-[100] h-[9vh] blur-effect-theme'
      }>
        <nav className='flex items-center justify-between nike-container'>
            ...
            <ul className='flex items-center justify-center gap-2'>
                <li className='grid items-center'>
                    <MagnifyingGlassIcon className={`icon-style ${navState && "filter brightness-0"} `} />
                </li>
                <li className='grid items-center'>
                ...
                <li className='grid items-center'>
                    <button type='button' onClick={onCartToggle}  className='border-none outline-none active:scale-110 transition-all duration-300 relative'>
                        <ShoppingBagIcon className={`icon-style ${navState && "filter brightness-0"} `}
                         />
